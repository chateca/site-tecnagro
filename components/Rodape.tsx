      ...
      <div className='container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left'>
        ...
        <div>
          ...
          <ul className='space-y-2 text-sm'>
            ...
            <li><Link href='#' className='hover:text-green-300'>Sobre nós</Link></li>
            <li><Link href='#' className='hover:text-green-300'>Serviços</Link></li>
            <li><Link href='#' className='hover:text-green-300'>Parceiros</Link></li>
            <li><Link href='#' className='hover:text-green-300'>Contatos</Link></li>
          </ul>
        </div>
