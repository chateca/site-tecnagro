...
function ProdutosEservicos() {
  ...
  return (
    ...
    <div className='container w-full grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-8'>
        ...
        height={200}
        sizes='200'
        className='about__item__folha absolute  -top-14 left-14 animate-mediaAnimation'
        />
        ...
        height={200}
        sizes='200'
        className='about__item__folha absolute bottom-0 -right-20 animate-mediaAnimation'
        />
        <div suppressHydrationWarning className='service__card border border-green-3 p-5 cursor-pointer rounded-md hover:-translate-y-5 duration-300 space-y-5'>
        ...
        <div suppressHydrationWarning className='service__card border border-green-3 p-5 cursor-pointer rounded-md hover:-translate-y-1 duration-300 space-y-5'>
            <div className='flex items-center gap-5'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12">
