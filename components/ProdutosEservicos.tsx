...
function ProdutosEservicos() {
  ...
  return (
    <div className='container w-full grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-8'>
        <div suppressHydrationWarning={true} className='service__card border border-green-3 p-5 cursor-pointer rounded-md hover:-translate-y-1 duration-300 space-y-5'>
