...
function ProdutosEservicos() {
  ...
  return (
    <div className='relative bg-white flex flex-col  overflow-hidden py-4 lg:pb-40 md:pb-20 pb-8'>
    ...
    <div className='container w-full grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-8'>
        ...
        />
        <div data-aos='fade-up' className='relative bg-green-1 border p-5 cursor-pointer rounded-md hover:-translate-y-5 duration-300 space-y-5 text-gray-200'>
        ...
        <div data-aos="fade-up" className='relative border bg-green-1 p-5 cursor-pointer rounded-md hover:-translate-y-1 duration-300 space-y-5 text-gray-200'>
            <div className='flex items-center gap-5'>
            <svg xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12">
