...
import { BuscarActividadesActivasPaginaPrincipal, BuscarAtividadeUser } from '@/lib/actions/actividades.actions'
...
async function page({params}:{params:{id:string}}) {
  ...
  return (
    <div className='relative pt-14 bg-white'>
      ...
      <h1 suppressHydrationWarning className='titulo atividade__item '>{getAtividade?.titulo}</h1>
      ...
      <div className='flex justify-between gap-8 p-4'>
        <div className='relative w-full h-96'>
             ...
             fill 
             sizes='100%'
             className='atividade__item object-cover rounded-xl'
             suppressHydrationWarning            
             />
        </div>

        <div className='flex flex-col items-center space-y-14'>
             <span suppressHydrationWarning className='atividade__item lg:text-2xl md:text-xl text-sm text-gray-500 font-mono'>{getAtividade?.descricao}</span>
