...
async function page({params}:{params:{id:number}}) {
  ...
  return (
    <div className='relative pt-14 bg-white'>
      ...
      <h1 suppressHydrationWarning className='atividade__item titulo'>{item?.titulo}</h1>
      ...
      <div className='flex md:flex-row flex-col justify-between gap-8 p-4'>
        ...
        <div className='flex flex-col items-center space-y-14'>
             <span suppressHydrationWarning className='atividade__item lg:text-2xl md:text-xl text-sm text-gray-500 font-mono'>{item?.desc}</span>
